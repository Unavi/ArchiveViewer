...
namespace ArchiveViewer.Library.WPF
{
    public class DataGridMultiSelectBinding : DependencyObject
    {
        public static readonly DependencyProperty IsSubscribedToSelectionChangedProperty =
            DependencyProperty.RegisterAttached(
                "IsSubscribedToSelectionChanged", typeof(bool), typeof(DataGridMultiSelectBinding),
        ...
        public static readonly DependencyProperty SelectedItemsProperty = DependencyProperty.RegisterAttached(
            "SelectedItems", typeof(IList), typeof(DataGridMultiSelectBinding),
        ...
        private static void OnSelectedItemsChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (!(d is ListBox || d is MultiSelector))
                throw new ArgumentException(
                    "Selector was attached to unsupported framework element. Supported are: ListView, DataGrid");
        ...
        private static void PushCollectionDataToSelectedItems(IList obs, DependencyObject selector)
        {
            ...
            // Maybe other things will use the multi selector base... who knows =P
        ...
        /// <summary>
        /// When the list box or grid fires a selectionChanged even, we update the attached list to
        /// match it.
        /// </summary>
        ...
        /// <summary>
        /// When the attached object implements INotifyCollectionChanged, the attached list box
